...
@MapperScan(basePackages = "com.forever.dao.one", sqlSessionFactoryRef = "sqlSessionFactory")
public class MybatisDatasourceOneConfig {
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        factoryBean.setMapperLocations(resolver.getResources("classpath:mapping/luckcloud/one/*.xml"));
