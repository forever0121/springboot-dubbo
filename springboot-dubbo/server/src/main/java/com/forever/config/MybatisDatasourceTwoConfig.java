...
@MapperScan(basePackages = "com.forever.dao.two", sqlSessionFactoryRef = "sqlSessionFactory2")
public class MybatisDatasourceTwoConfig {
    ...
    public SqlSessionFactory sqlSessionFactory2() throws Exception {
        ...
        factoryBean.setMapperLocations(resolver.getResources("classpath:mapping/luckcloud/two/*.xml"));
